...
Devise.setup do |config|
  ...
  # config.secret_key = '1a6cf5c209e6357552e41b7bf458360806b0171ab087e828bcd4568abaf46226f14d6ddf8f94eb40da1d9bf25b1ccb4a4f0af41c8e8c98ae88de6c69d2036d14'
  ...
  config.mailer_sender = ENV.fetch("MAILER_FROM", "noreply@townai.local")
  ...
  # Paranoid mode: behave the same regardless if the e-mail provided was right or wrong.
  ...
  # config.pepper = '0ec01ab535c9c1779856593fa35c963780d4eafe7a20b5f4d5e189177bdffe48af30b5b6fd72562c542f373874dae380cb2ee6c48c01d54336b1516ba64d4938'
  ...
  # Using 2 weeks with sliding expiration (extend_remember_period below)
  config.remember_for = 2.weeks

  # Invalidates all the remember me tokens when the user signs out.
  config.expire_all_remember_me_on_sign_out = true

  # Sliding expiration: extends the user's remember period when remembered via cookie.
  # Each request extends the session, providing best UX while maintaining security.
  config.extend_remember_period = true

  # Secure cookie settings - secure: true in production (requires HTTPS)
  ...
  # Session timeout after inactivity. Combined with rememberable's sliding expiration,
  # this provides a good balance of security and UX.
